...
export default async function AnalyticsPage() {
  ...
  const [campaigns, stats, segCounts] = await Promise.all([
      ...
      <div className="p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        <AnalyticsCharts
          ...
          segmentCounts={{
            ...
            inactive: segCounts.inactive,
          }}
        />

        {/* Bottom: Campaign Performance Table + Insights */}
            ...
            <div className="space-y-3 text-sm">
              {bestCampaign && (
                <div className="p-3 rounded-lg bg-emerald-50">
                  ...
                  <div className="text-xs text-emerald-700 mt-1">
                    {bestCampaign.name} — {bestCampaign.delivery_rate}% delivery
                  </div>
                </div>
              )}
              <div className="p-3 rounded-lg bg-blue-50">
                ...
                <div className="text-xs text-blue-700 mt-1">
                  {formatNumber(segCounts.loyal)} loyal customers driving repeat business
                </div>
              </div>
              {segCounts.inactive > 0 && (
                <div className="p-3 rounded-lg bg-orange-50">
                  ...
                  <div className="text-xs text-orange-700 mt-1">
                    {formatNumber(segCounts.inactive)} customers need re-engagement
                  </div>
                </div>
              )}
              <div className="p-3 rounded-lg bg-slate-50">
                ...
                <div className="text-xs text-slate-700 mt-1">
                  Avg delivery rate: <span className="font-semibold">{stats.delivery_rate}%</span>
                </div>
              </div>
            </div>
          </Card>
